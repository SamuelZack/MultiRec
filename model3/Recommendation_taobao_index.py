...
from Recommendation_taobao_Method import data_partition_Taobao, evaluate_valid
from Recommendation_taobao_Model import Args, WarpSampler, Model

args = Args()

tstInt = None
with open('./Datasets/Taobao_tst_int', 'rb') as fs:
...
print('maxlen...', args.maxlen, '   heads....', args.num_heads, '   dropout...', args.dropout_rate, '  lr,...', args.lr,
      ' emb size...', args.hidden_units, 'min len..', args.min_seq, 'L2 Reg:..', args.l2_emb, 'decay.. 0.001')
# print(' augmentation only crop 0.2 and mask 0.4 .... loss weight 0.02')
dataset = data_partition_Taobao(args.dataset)
print('here')
