...
class Model():
    def __init__(self, usernum, itemnum, args, reuse=None):
        ...
        from Recommendation_taobao_Method import embedding, Model_pro
        ...
        # self.final_loss = tf.cond(self.epoch < 50, lambda: self.loss, lambda: (self.loss + 0.1 * self.classification_loss))
    ...
    def predict(self, sess, u, seq, item_idx, seq_cxt, test_item_cxt, buy_seq_mask, cart_seq_mask, fav_seq_mask,
                click_seq_mask):
        from Recommendation_taobao_index import model
...
class WarpSampler(object):
    def __init__(self, User, Beh, Beh_w, Behaviors, usernum, itemnum, batch_size=64, maxlen=10, n_workers=1):
        ...
        self.processors = []
        from Recommendation_taobao_Method import sample_function
